...
export const pages = [
  ...
  },
  {
    ...
    filter: "grayscale(100%) brightness(60%) contrast(180%)",// brightness(50%) contrast(120%)", // ",
    color: "hsl(187,57%,66%)",//"hsl(187,57%,66%)",//"hsl(200,95%,63%)",
    devices: ["S", "M", "L"],
  ...
  },
  {
    ...
    color: "hsl(274,33%,55%)",//"hsl(167,57%,66%)",//"hsl(187,57%,66%)",//"hsl(200,95%,63%)",
    devices: ["S", "M", "L"],
    tags: ["responsive"],
    level: 2
  },
  ...
  },
  {
    ...
    // filter: "grayscale(100%) invert(1) contrast(.7) brightness(2)",//contrast(40%) brightness(150%)",
    color: "hsl(37,95%,63%)",//"hsl(167,72%,60%)",//"hsl(274,33%,55%)",
